...
const saveChanges = async () => {
  ...
  try {
    ...
    // Use backend image if returned, otherwise keep previewUrl
  ...
  profileImage: newProfileImage,
    ...
    // Update preview to keep showing the new image
    setPreviewUrl(newProfileImage);
    setSelectedFile(null);
                ...
                <div className="flex flex-col items-center text-center">
                  <div className="relative">
                    <div className="h-28 w-28 rounded-full bg-green-100 overflow-hidden flex items-center justify-center shadow">
                      <Image
                        src={previewUrl || user?.profileImage || "/profile.png"}
                        alt="Profile"
                        width={112}
                        height={112}
                    ...
                    <label
                      ...
                      className="absolute bottom-0 right-0 h-10 w-10 rounded-full bg-green-600 text-white flex items-center justify-center shadow hover:opacity-90 cursor-pointer"
                      title="Edit photo"
                    >
                      ✎
                    </label>
